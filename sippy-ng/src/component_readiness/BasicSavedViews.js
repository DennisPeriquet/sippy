...
export default function BasicSavedViews(props) {
  ...
  return (
    <FormControl variant="outlined" fullWidth>
      <InputLabel id="saved-views-label">
        <Typography className="basicsavedviews-label">Selected View</Typography>
      </InputLabel>
      <Select
